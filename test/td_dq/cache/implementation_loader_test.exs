defmodule TdDd.Cache.ImplementationLoaderTest do
  ...
  describe "ImplementationLoader.cache_implementations/2" do
    ...
    test "encodes and puts cache entries with rule" do
      %{id: id, implementation_ref: implementation_ref, rule: %{id: rule_id, name: rule_name}} = insert(:implementation)
    ...
    test "add relations between implementation_id and implementation_ref" do
      ...
      assert 3 == ImplementationLoader.cache_map_implementation_id_to_implementation_ref()

      result =  ImplementationCache.get_relation_impl_id_and_impl_ref
