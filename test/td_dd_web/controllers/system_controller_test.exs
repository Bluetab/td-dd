  ...
  describe "create system" do
    ...
    test "renders system when image file is valid", %{conn: conn, swagger_schema: schema} do
      valid_attr =
        ...
        |> Map.put("df_content", %{"image_name" => %{"value" => @valid_image, "origin" => "user"}})
    ...
    test "renders errors when image file is invalid", %{conn: conn} do
      invalid_attr =
        @create_attrs
        |> Map.put("df_content", %{
          "image_name" => %{"value" => @invalid_image, "origin" => "user"}
        })
  ...
  describe "update system" do
    ...
    test "renders system when image file is valid", %{
      ...
      assert %{
               ...
               "external_id" => "some updated external_id",
               "name" => "some updated name",
               "df_content" => %{"image_name" => %{"value" => @valid_image, "origin" => "user"}}
             } = data

      valid_attr =
        @update_attrs
        |> Map.put("df_content", %{"image_name" => %{"value" => nil, "origin" => "user"}})
      ...
      assert %{
               ...
               "external_id" => "some updated external_id",
               "name" => "some updated name",
               "df_content" => %{"image_name" => %{"value" => nil, "origin" => "user"}}
             } = data
    end
