defmodule TdDd.Lineage.GraphsTest do
  ...
  describe "hash" do
    ...
    test "find by hash returns nil if graph exists but it is stale" do
      ...
      insert(:unit_event, event: "LoadSucceeded", inserted_at: ~U[2001-01-03 00:00:00Z], unit: unit)
      insert(:unit_event, event: "LoadSucceeded", inserted_at: ~U[2001-01-01 00:00:00Z], unit: unit)
