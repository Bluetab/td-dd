defmodule TdDd.XLSX.WriterTest do
  ...
  describe "TdDd.XLSX.Writer.data_structure_type_information/2" do
    test "returns content fields and structures grouped by structure type" do
  ...
  describe "TdDd.XLSX.Writer.rows_by_structure_type/3" do
    test "test returns the content split by type for editable download" do
    ...
    test "test returns the content split by type for non-editable download" do
      domain = CacheHelpers.insert_domain()
