defmodule TdDd.Access.BulkLoadTest do
  ...
  setup do
    ...
    [data_structure_id: data_structure_id, accesses: accesses, bad_accesses: bad_accesses, ds_external_id: ds_external_id, user: user]
  end

  describe "bulk_load/2" do
    test "mixed good and bad accesses", %{accesses: accesses, bad_accesses: bad_accesses, ds_external_id: ds_external_id, user: %{id: user_id, user_name: user_name}} do
      { entries_count, invalid_changesets, inexistent_external_ids } = BulkLoad.bulk_load(accesses ++ bad_accesses)
