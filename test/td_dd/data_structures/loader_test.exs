defmodule TdDd.LoaderTest do
  ...
  describe "loader" do
    test "load/1 does something" do
      ...
      field2 = insert(:data_field, id: 99, name: "F2", type: "T2", description: "D2", precision: "P2")
      field3 = insert(:data_field, id: 991, name: "F123123", type: "T2", description: "Will be deleted", precision: "P2")
      entries = [field1, field2, field3] |> Enum.map(fn %{id: id} -> %{data_field_id: id, data_structure_version_id: dsv.id} end)
      ...
      assert {:ok, context} = Loader.load(structure_records, field_records, audit_fields)
