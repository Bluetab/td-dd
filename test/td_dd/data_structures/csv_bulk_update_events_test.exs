defmodule TdDd.DataStructures.CsvBulkUpdateEventsTest do
  ...
  setup do
    insert(:csv_bulk_update_event, user_id: 1, csv_hash: "hash_1", inserted_at: ~U[2020-01-01 00:00:01Z])
    insert(:csv_bulk_update_event, user_id: 1, csv_hash: "hash_1", inserted_at: ~U[2020-01-02 00:00:01Z], status: "STARTED")
    insert(:csv_bulk_update_event, user_id: 2, csv_hash: "hash_2", inserted_at: ~U[2020-01-01 00:00:01Z])
    insert(:csv_bulk_update_event, user_id: 2, csv_hash: "hash_2", inserted_at: DateTime.utc_now(), status: "STARTED")
    insert(:csv_bulk_update_event, user_id: 2, csv_hash: "hash_3", inserted_at: ~U[2020-01-01 00:00:01Z])
    insert(:csv_bulk_update_event, user_id: 2, csv_hash: "hash_3", inserted_at: ~U[2020-01-02 00:00:01Z], status: "STARTED")
    :ok
  end
