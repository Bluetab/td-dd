Feature: Data Dictionary Administration
  ...
  Scenario: Create a new Data Structure
    ...
    And "app-admin" is able to view data structure in system "SAS" group "Risks" and structure "TKIDS0001"  with following data:
      | Field               | Value                                                                |
      | Group               | Risks                                                                |
      | Name                | TKIDS0001                                                            |
      | Description         | We are describing this table as a table in Risks group in SAS System |
  ...
  Scenario: Load metadata (structures and fields) into the system in bulk mode
    ...
    When "app-admin" tries to load dictionary data with following information:
      ...
      | Data Structure   | S001     | Risks        | TKIDS0001      |                     | TKIDS0001 Description              |           |           |          |                     | Domain_1    |
      | Data Structure   | S001     | Risks        | TKIDS0002      |                     | TKIDS0002 Description              |           |           |          |                     | Domain_1    |
      | Data Structure   | S002     | Teradata     | TKIDS0003      |                     | TKIDS0003 Description              |           |           |          |                     |             |
      | Field            | S001     | Risks        | TKIDS0001      | My_Personal01_Field | My_Personal01_Field Description    | CHAR      | 20        | Yes      | BCID001             |             |
      | Field            | S001     | Risks        | TKIDS0001      | My_Personal02_Field | My_Personal02_Field Description    | VARCHAR   | 80        | No       | BCID002             |             |
      | Field            | S001     | Risks        | TKIDS0001      | My_Personal03_Field | My_Personal03_Field Description    | DATE      |           | No       | BCID003             |             |
      | Field            | S001     | Risks        | TKIDS0002      | My_Personal01_Field | My_Personal01bis_Field Description | TIMESTAMP |           | No       | BCID001             |             |
      | Field            | S001     | Risks        | TKIDS0002      | My_Personal04_Field | My_Personal04_Field Description    | SMALLINT  |           | Yes      |                     |             |
