Feature: Rule Implementations
  ...
  # TODO: Unit test this. Remove acceptance tests    
  # Scenario: Create a new Rule Implementation which does not ths same numer of params as its Rule Type
  #   Given user "my-user" logged in the application
  #   And a existing Rule Type with name "Integer Values Range" and the following parameters:
  #     | Params                                                                                                        |
  #     | {"type_params": [{"name": "Minimum Value", "type": "integer"}, {"name": "Maximum Value", "type": "integer"}]} |
  ...
  #
  # Scenario: Create a new Rule Implementation with a different System Param type to its Rule Type
  #   Given user "my-user" logged in the application
  #   And a existing Rule Type with name "Integer Values Range" and the following parameters:
  #     | Params                                                                                                        |
  #     | {"type_params": [{"name": "Minimum Value", "type": "integer"}, {"name": "Maximum Value", "type": "integer"}]} |
  ...
  #   Then the system returns a result with code "Unprocessable Entity"
  #
  # Scenario: Create a new Rule Implementation which params do not match with its Rule Type params
  #   Given user "my-user" logged in the application
  #   And a existing Rule Type with name "Integer Values Range" and the following parameters:
  #     | Params                                                                                                        |
  #     | {"type_params": [{"name": "Minimum Value", "type": "integer"}, {"name": "Maximum Value", "type": "integer"}]} |
