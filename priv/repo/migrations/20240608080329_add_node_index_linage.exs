defmodule TdDd.Repo.Migrations.AddNodeIndexLinage do
  ...
  def up do
    execute("CREATE INDEX nodes_external_id_hash_index ON nodes USING hash (external_id);")

    execute(
      "CREATE UNIQUE INDEX nodes_external_id_btree_index ON nodes USING btree (external_id);"
    )
  end
