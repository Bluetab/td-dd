defmodule TdDd.Repo.Migrations.AddUnitsIndexLinage do
  ...
  def up do
    execute(
      "CREATE INDEX units_nodes_node_id_hash_index ON public.units_nodes USING hash (node_id);"
    )

    execute(
      "CREATE INDEX units_nodes_node_id_btree_index ON public.units_nodes USING btree (node_id);"
    )
  end
