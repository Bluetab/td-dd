defmodule TdDq.Repo.Migrations.NameRefactorRenameTables do
  ...
  def up do
    ...
    execute("alter table quality_rules rename constraint quality_rules_pkey to rule_implementations_pkey")
    execute("alter table quality_rule_types rename constraint quality_rule_types_pkey to rule_types_pkey")

    execute("alter table quality_rules rename constraint quality_rules_quality_control_id_fkey  to rule_implementations_rule_id_fkey")
  ...
  def down do
    ...
    execute("alter table rule_implementations rename constraint rule_implementations_pkey to quality_rules_pkey")
    execute("alter table rule_types rename constraint rule_types_pkey to quality_rule_types_pkey")

    execute("alter table rule_implementations rename constraint rule_implementations_rule_id_fkey  to quality_rules_quality_control_id_fkey")
