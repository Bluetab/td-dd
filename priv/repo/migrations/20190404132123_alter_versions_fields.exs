defmodule TdDd.Repo.Migrations.AlterVersionsFields do
  ...
  def up do
    ...
    alter table("versions_fields") do
      modify(:data_structure_version_id, references(:data_structures, on_delete: :delete_all))
  ...
  def down do
    ...
    alter table("versions_fields") do
      modify(:data_structure_version_id, references(:data_structures, on_delete: :nothing))
