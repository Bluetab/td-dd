defmodule TruedatWeb do
  ...
  def controller(log \\ :info) do
    quote bind_quoted: [log: log] do
      use Phoenix.Controller, namespace: TruedatWeb, log: log

      import Plug.Conn

      alias TruedatWeb.ErrorView
      alias TruedatWeb.Router.Helpers, as: Routes
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/truedat_web/templates",
        namespace: TruedatWeb

      # Import convenience functions from controllers
      import Phoenix.Controller,
        only: [get_flash: 1, get_flash: 2, view_module: 1, view_template: 1]

      import TruedatWeb.ErrorHelpers
      alias TruedatWeb.Router.Helpers, as: Routes
    end
  end
