defmodule DataDictionaryWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :data_dictionary

  socket "/socket", DataDictionaryWeb.UserSocket
  ...
  plug Plug.Static,
    at: "/", from: :data_dictionary, gzip: false,
