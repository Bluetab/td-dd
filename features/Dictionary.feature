Feature: Data Dictionary Administration
  ...
  Scenario: Load metadata (structures and fields) into the system in bulk mode
    When "app-admin" tries to load dictionary data with following information:
      | File             | System  | Group        | Structure Name | Field Name          | Description                        | Type      | Precision | Nullable | Business Concept ID |
      | Data Structure   | SAS     | Risks        | TKIDS0001      |                     | TKIDS0001 Description              |           |           |          |                     |
      | Data Structure   | SAS     | Risks        | TKIDS0002      |                     | TKIDS0002 Description              |           |           |          |                     |
