defmodule TdDd.MixProject do
  ...
  defp deps do
    [
      ...
      # {:td_cache, git: "https://github.com/Bluetab/td-cache.git", tag: "4.40.5", override: true},
      {:td_cache, git: "https://github.com/Bluetab/td-cache.git", branch: "feature/td-4230", override: true},
