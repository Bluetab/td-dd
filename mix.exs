defmodule TdDd.MixProject do
  ...
  defp deps do
    [
      ...
      {:td_cache,
       git: "https://github.com/Bluetab/td-cache.git", branch: "feature/td-5091", override: true},
      {:td_df_lib, git: "https://github.com/Bluetab/td-df-lib.git", branch: "feature/td-5091"},
