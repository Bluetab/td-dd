defmodule TdDd.MixProject do
  ...
  defp deps do
    [
      ...
      # {:td_cache, git: "https://github.com/Bluetab/td-cache.git", tag: "5.4.0"},
      # {:td_df_lib, git: "https://github.com/Bluetab/td-df-lib.git", tag: "5.4.1"},
      {:td_cache, git: "https://github.com/Bluetab/td-cache.git", branch: "feature/td-5650"},
      {:td_df_lib, git: "https://github.com/Bluetab/td-df-lib.git", branch: "feature/td-5650"},
