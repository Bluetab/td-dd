  ...
  defp deps do
    [
      ...
      {:elasticsearch,
       ...
       {:td_cache,
       git: "https://github.com/Bluetab/td-cache.git", branch: "feature/td-3806", override: true},
      {:td_df_lib, git: "https://github.com/Bluetab/td-df-lib.git", branch: "feature/td-3806"},
